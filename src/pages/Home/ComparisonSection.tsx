...
const cards = [
    ...
    },
    {
        ...
        image: "/aerial.jpg",
        points: [
            "270° awning creates a generous shaded outdoor living area.",
            "Excellent ventilation keeps the cabin comfortable.",
            "Thoughtful lighting and easy-access storage make camp life effortless.",
        ],
        bg: palette.navy,
        headingColor: palette.light,
        bodyColor: palette.light
